...
library(ggplot2)
plotData <- read.csv("C:/users/jeremy/documents/Coursera/Developing Data Products/data/Adult.csv",header=TRUE,na.strings=" ?")
plotData <- plotData[complete.cases(data),]

plot <- ggplot(data=plotData,aes(y=hours.per.week,x=Age))+geom_point(aes(color=salary))+labs(title= "Scatterplot",x="Age",y="Hours worked per week")
print(plot) 
```
